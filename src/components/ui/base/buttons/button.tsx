...
export const styles = sortCx({
  ...
  colors: {
    primary: {
      root: [
        // Outlined: rust-orange label + border on a transparent fill.
        'bg-linear-to-b from-neutral-900/40 to-neutral-900/35 text-fg-tertiary transition antialiased',
        // Hover: a slight radial glow of brand colour rising from the bottom edge.
        'before:absolute before:inset-0 before:border before:border-primary',
        ...
        // Icon styles
        '*:data-icon:text-fg-tertiary hover:*:data-icon:text-fg-primary',
      ].join(' '),
    },
    accent: {
      root: [
