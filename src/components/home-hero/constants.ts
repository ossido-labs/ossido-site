...
export const NOTO_STACK = "'Noto Sans', 'Noto Sans Devanagari', 'Noto Sans JP', sans-serif";
...
export const RING_ENTER = '[animation:ring-in_1.5s_cubic-bezier(0.33,1,0.68,1)_both] motion-reduce:[animation:none]';
