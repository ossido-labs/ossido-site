...
export default function ErrorRoute({ reset }: OssidoErrorProps): JSX.Element {
  return (
    ...
    >
      <p className="font-mono text-sm tracking-widest text-ossido-orange">
        4Fe + 3O₂ → 2Fe₂O₃
      </p>
      <h1 className="mt-3 text-4xl font-extrabold text-white">
        500 - This page corroded
      </h1>
      <p className="mt-3 font-light text-ossido-text-dim">
        A reaction went sideways and oxidised right through. Give it another
        shot.
      </p>
      <div className="mt-5 flex items-center gap-5">
        ...
        <Link
          href="/"
          className="font-medium text-ossido-text-dim hover:underline"
        >
          Back home
        </Link>
      </div>
