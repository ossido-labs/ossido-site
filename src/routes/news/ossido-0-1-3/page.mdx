...
a **Rust function** to _do_ something - create, update, delete, submit a form - and
...
synchronous microtasks - so anything that resolves _asynchronously_ during render
...
clock is virtual, work that can _never_ resolve at build time - a live `fetch` to a
