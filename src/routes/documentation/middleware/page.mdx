...
[handlers](/documentation/rust-backend) load a route's data, middleware sits _in
front_ of routes and processes every request that passes through.
...
A `#[middleware]` function returns a _single_ Tower `Layer`, but you'll usually
